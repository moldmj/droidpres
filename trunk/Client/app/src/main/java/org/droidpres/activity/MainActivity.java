...
public class MainActivity extends ListActivity {
    ...
    private final static int MAINLIST_DOCUMENTS		= 4;
    ...
    private void ShowListDoc() {
        Bundle mDocParams = new Bundle();
        Intent document = new Intent(this, DocumentListActivity.class);
        mDocParams.putLong(Const.EXTRA_CLIENT_ID, 0);
        mDocParams.putString(Const.EXTRA_CLIENT_NAME, "Все заказы");
