...
public class SetupRootActivity extends PreferenceActivity{
	...
	public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		if (preference.getKey().equals("clean_ref")) {
            ...
            db.execSQL("DELETE FROM " + DBDroidPres.TABLE_PRODUCTS_PRICES);
            db.execSQL("DELETE FROM " + DBDroidPres.TABLE_PRODUCTS_AVAILIBLE);
			db.execSQL("DELETE FROM " + DBDroidPres.TABLE_CLIENT_GROUP);
			db.execSQL("DELETE FROM " + DBDroidPres.TABLE_PRODUCT_GROUP);
            db.execSQL("DELETE FROM " + DBDroidPres.TABLE_CHARACTERISTIC);
    ...
    public static boolean getCharacteristicsuse(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean(context.getString(R.string.USER_CHARACTERISTICS), true);
    }

    public static int getExchangeTimeout(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return Integer.parseInt(sharedPreferences.getString(context.getString(R.string.TRANSFER_TIMEOUT), "").trim());
    }

    public static String getReserveServer(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getString(context.getString(R.string.TRANSFER_RESERVE_SERVER), "");
    }
    ...
    public static boolean getHTTPCompressionEnable(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getBoolean(context.getString(R.string.HTTP_COMPRESSION), true);
    }
