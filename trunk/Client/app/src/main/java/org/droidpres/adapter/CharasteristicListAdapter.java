...
public class CharasteristicListAdapter extends SimpleCursorAdapter implements ViewBinder  {
...
//	private SectionIndexer mIndexer;
	...
	public CharasteristicListAdapter(Context context, int layout, Cursor cursor, String[] from, int[] to) {
...
//		mIndexer = CreateIndexer(cursor);
	...
	public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
		...
		case 0: // _id По этому полю обрабатываем количество в документе 
			...
			mQty = mDocData.getQtyByCharacteristicId(mId);
			if (mQty > 0) {
			...
			return true;
		case 4: // available Остаток на складе
