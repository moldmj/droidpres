...
public class XMLRPCClient extends XMLRPCCommon {
	 ...
	 */
	public XMLRPCClient(URI uri,int timeout) {
	 ...
	 */
	public XMLRPCClient(String url,int timeout) {
		this(URI.create(url),timeout);
	}
	 ...
	 */
	public XMLRPCClient(URL url, int timeout) {
		this(URI.create(url.toExternalForm()),timeout);
	}
	 ...
	 */
	public XMLRPCClient(URI uri, String username, String password,int timeout) {
        this(uri,timeout);
	 ...
	 * @param HTTP Server - Basic Authentication - Password
	 */
	public XMLRPCClient(String url, String username, String password,int timeout) {
		this(URI.create(url), username, password,timeout);
	 ...
	 * @param HTTP Server - Basic Authentication - Password
	 */
	public XMLRPCClient(URL url, String username, String password,int timeout) {
		this(URI.create(url.toExternalForm()), username, password,timeout);
		this.username = username;
		this.password = password;
	}
...
AuthScope.ANY_REALM),
	...
	public Object callEx(String method, Object[] params) throws XMLRPCException {
		try {
			...
			postMethod.addHeader("Authorization", "Basic " + Base64Coder.encodeString((username + ":" + password)));
